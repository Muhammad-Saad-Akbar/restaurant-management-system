  ...
  <div class="w-full flex h-screen p-2">
    ...
    <div class="w-[45%] flex flex-col justify-center items-center p-12">
      <div class="w-full max-w-md">
        ...
        <h2 class="font-serif-display text-4xl mb-2 text-gray-800">Welcome Back</h2>
        <p class="font-serif-display text-gray-500 mb-8">Enter your email and password to access your account</p>
        ...
        <div class="mb-5">
          ...
          focus:ring-2 focus:ring-gray-300" v-model="email">
        </div>
        ...
        <div class="mb-5">
          ...
          <div class="relative">
            ...
            focus:outline-none focus:ring-2 focus:ring-gray-300" v-model="password">
